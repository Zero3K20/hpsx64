...
WaveOutDriver* SPU::waveout_driver;
...
#ifdef SPU1_USE_WASAPI

	wasapi_event_driver.init();
	wasapi_event_driver.start();
...
//#endif
	...
	*/
	...
	wasapi_event_driver.pushSample(adpcm_decoder::clamp(SampleL), adpcm_decoder::clamp(SampleR));
