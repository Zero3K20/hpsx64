...
namespace Playstation1
{
	...
	public:
		...
		static constexpr char* REG_NAMES0[419] = {
			// 0x0
		...
		static constexpr char* REG_NAMES1[20] = {
		...
		static constexpr char* REG_NAMES2[5] = {
			// 0x7c0
		...
		*/
		...
		inline void UpdatePitch ( int Channel, u32 Pitch, u32 Reg_PMON, s32 PreviousSample );
	...
	public:
		...
		static WaveOutDriver* waveout_driver;
