...
void Execute::SB ( Instruction::Format i )
{
	...
	{
#if defined INLINE_DEBUG_SB || defined INLINE_DEBUG_R3000A || defined INLINE_DEBUG_ICACHE
		debug << "; IsC SB Addr:" << hex << StoreAddress;
#endif
...
void Execute::SH ( Instruction::Format i )
{
	...
	if ( r->CPR0.Status.IsC )	// *todo* - I think we need to check if DCache is isolated too - unsure
	{
#if defined INLINE_DEBUG_SH || defined INLINE_DEBUG_R3000A || defined INLINE_DEBUG_ICACHE
		debug << "; IsC SH Addr:" << hex << StoreAddress;
#endif
...
void Execute::SW ( Instruction::Format i )
{
	...
	if ( r->CPR0.Status.IsC )	// *todo* - I think we need to check if DCache is isolated too - unsure
	{
#if defined INLINE_DEBUG_SW || defined INLINE_DEBUG_R3000A || defined INLINE_DEBUG_ICACHE
		debug << "; IsC SW Addr:" << hex << StoreAddress;
#endif
...
void Execute::SWC2 ( Instruction::Format i )
{
	...
	{
#if defined INLINE_DEBUG_SWC2 || defined INLINE_DEBUG_R3000A || defined INLINE_DEBUG_ICACHE
	debug << " IsC SWC2 Addr:" << hex << StoreAddress;
#endif
...
void Execute::SWL ( Instruction::Format i )
{
	...
	if ( r->CPR0.Status.IsC )	// *todo* - I think we need to check if DCache is isolated too - unsure
	{
#if defined INLINE_DEBUG_SWL || defined INLINE_DEBUG_R3000A || defined INLINE_DEBUG_ICACHE
		debug << "; IsC SWL Addr:" << hex << StoreAddress;
#endif
...
void Execute::SWR ( Instruction::Format i )
{
	...
	if ( r->CPR0.Status.IsC )	// *todo* - I think we need to check if DCache is isolated too - unsure
	{
#if defined INLINE_DEBUG_SWR || defined INLINE_DEBUG_R3000A || defined INLINE_DEBUG_ICACHE
		debug << "; IsC SWR Addr:" << hex << StoreAddress;
#endif
