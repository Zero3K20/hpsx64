...
//#pragma once
#ifndef __PS1_DMA_H__
#define __PS1_DMA_H__
...
namespace Playstation1
{
	...
	public:
		...
		*/
		...
		// starting at 0x1f801080
		static constexpr char* REG_NAMES[] = { 
			"DMA0_MADR", "DMA0_BCR", "DMA0_CHCR", "DMA0_CHCRm",
			"DMA1_MADR", "DMA1_BCR", "DMA1_CHCR", "DMA1_CHCRm",
			"DMA2_MADR", "DMA2_BCR", "DMA2_CHCR", "DMA2_CHCRm",
			"DMA3_MADR", "DMA3_BCR", "DMA3_CHCR", "DMA3_CHCRm",
			"DMA4_MADR", "DMA4_BCR", "DMA4_CHCR", "DMA4_CHCRm",
			"DMA5_MADR", "DMA5_BCR", "DMA5_CHCR", "DMA5_CHCRm",
			"DMA6_MADR", "DMA6_BCR", "DMA6_CHCR", "DMA6_CHCRm",
			"DMA_PCR", "DMA_ICR", "UNK0", "UNK1"
		};

#ifdef PS2_COMPILE
		// starting at 0x1f801500
		static constexpr char* REG_NAMES2[] = {
			"DMA7_MADR", "DMA7_BCR", "DMA7_CHCR", "DMA7_CHCRm",
			"DMA8_MADR", "DMA8_BCR", "DMA8_CHCR", "DMA8_CHCRm",
			"DMA9_MADR", "DMA9_BCR", "DMA9_CHCR", "DMA9_TADR",
			"DMA10_MADR", "DMA10_BCR", "DMA10_CHCR", "DMA10_CHCRm",
			"DMA11_MADR", "DMA11_BCR", "DMA11_CHCR", "DMA11_TADR",
			"DMA12_MADR", "DMA12_BCR", "DMA12_CHCR", "DMA12_CHCRm",
			"DMA_SIF0_CTRL", "DMA_SIF1_CTRL", "DMA_SIF2_CTRL", "DMA_UNK_CTRL",
			"DMA_PCR2", "DMA_ICR2", "DMA_ENABLE", "DMA_INTR"
		};
#endif
...
#endif	// end #ifndef __PS1_DMA_H__
