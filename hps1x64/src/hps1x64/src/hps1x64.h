...
namespace Playstation1
{
	...
	public:
		...
		static constexpr const char* ProgramWindow_Caption = "hps1x64";

		static WindowClass::Window* ProgramWindow;

		static std::unique_ptr<OpenGLWindow> m_prgwindow;

		//static bool bIsDebugWinActive;
		//static DebugWindow* m_debugwin;
	...
	public:
		...
		int RunProgram();
		void RunProgram_Normal();
		void RunProgram_Normal_VirtualMachine();
		...
		static void OnClick_Video_Renderer_Software_Vulkan(int i);
