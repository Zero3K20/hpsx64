...
#define ALLOW_VERBOSE_DEBUG_PS1_CDVD_READ
#define ALLOW_VERBOSE_DEBUG_PS1_CDVD_WRITE
...
bool CDVD::bEnableVerboseDebugRead;
bool CDVD::bEnableVerboseDebugWrite;
...
#ifdef ALLOW_VERBOSE_DEBUG_PS1_CDVD_READ
	if (bEnableVerboseDebugRead)
	{
		cout << "\nPS1 CDVD READ ADDR:0x" << hex << Address;

		if ((Address & 0xffff) < 0x2040)
		{
			cout << " " << REG_NAMES_READ[(Address >> 0) & 0x3f];
		}
		else
		{
			cout << " ERROR";
...
#endif	// end #ifdef ALLOW_VERBOSE_DEBUG_PS1_CDVD_READ
...
#ifdef ALLOW_VERBOSE_DEBUG_PS1_CDVD_WRITE
	if (bEnableVerboseDebugWrite)
	{
		cout << "\nPS1 CDVD WRITE ADDR:0x" << hex << Address;

		if ((Address & 0xffff) < 0x2040)
		{
			cout << " " << REG_NAMES_WRITE[(Address >> 0) & 0x3f];
		}
		else
		{
			cout << " ERROR";
...
#endif	// end #ifdef ALLOW_VERBOSE_DEBUG_PS1_CDVD_WRITE
...
#define VERBOSE_DVD_READ
#ifdef VERBOSE_DVD_READ
			// need some message for testing
