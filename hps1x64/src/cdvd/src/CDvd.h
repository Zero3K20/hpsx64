...
namespace Playstation1
{
	...
	public:
		...
		static constexpr char c_cRegion_JAP[] = { 0, 'J', 'j', 'p', 'n', 0, 'J', 0 };
		static constexpr char c_cRegion_US[] = { 0, 'A', 'e', 'n', 'g', 0, 'U', 0 };
		static constexpr char c_cRegion_EU[] = { 0, 'E', 'e', 'n', 'g', 0, 'O', 0 };
		static constexpr char c_cRegion_H[] = { 0, 'H', 'e', 'n', 'g', 0, 'E', 0 };
		static constexpr char c_cRegion_R[] = { 0, 'R', 'e', 'n', 'g', 0, 'A', 0 };
		static constexpr char c_cRegion_C[] = { 0, 'C', 's', 'c', 'h', 0, 'C', 0 };
		static constexpr char c_cRegion_Korea[] = { 0, 'K', 'k', 'o', 'r', 0, 'M', 0 };


		static constexpr char* REG_NAMES_READ[] = {
			"UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "NCOMMAND", "NREADY", "ERROR", "BREAK",
			"INTERRUPT_REASON", "UNKNOWN", "STATUS", "TRAY_STATE", "UNKNOWN", "UNKNOWN", "UNKNOWN", "DISK_TYPE",
			"UNKNOWN", "UNKNOWN", "UNKNOWN", "DISK_SPEED", "UNKNOWN", "UNKNOWN", "SCOMMAND", "SREADY",
			"SDATAOUT", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN",
			"READ_KEY_X1", "READ_KEY_X1", "READ_KEY_X1", "READ_KEY_X1", "READ_KEY_X1", "UNKNOWN", "UNKNOWN", "UNKNOWN",
			"READ_KEY_X2", "READ_KEY_X2", "READ_KEY_X2", "READ_KEY_X2", "READ_KEY_X2", "UNKNOWN", "UNKNOWN", "UNKNOWN",
			"READ_KEY_X3", "READ_KEY_X3", "READ_KEY_X3", "READ_KEY_X3", "READ_KEY_X3", "UNKNOWN", "UNKNOWN", "UNKNOWN",
			"READ_KEY_15", "READ_KEY_XOR", "READ_DEC_SET", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN"
		};

		static constexpr char* REG_NAMES_WRITE[] = {
			"UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "NCOMMAND", "NPARAM", "HOWTO", "UNKNOWN",
			"INTERRUPT_ACKNOWLEDGE", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN",
			"UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "SCOMMAND", "SPARAM",
			"UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN",
			"UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN",
			"UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN",
			"UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN",
			"UNKNOWN", "UNKNOWN", "DEC_SET", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN", "UNKNOWN"
		};
