...
#define ALLOW_VERBOSE_DEBUG_PS1_INTC_READ
#define ALLOW_VERBOSE_DEBUG_PS1_INTC_WRITE
...
bool Intc::bEnableVerboseDebugRead;
bool Intc::bEnableVerboseDebugWrite;
...
u32 Intc::Read ( u32 Address )
{
...
#ifdef ALLOW_VERBOSE_DEBUG_PS1_INTC_READ
	if (bEnableVerboseDebugRead)
	{
		cout << "\nPS1 INTC READ ADDR:0x" << hex << Address;

		if ((Address & 0xffff) < 0x1800)
		{
			cout << " " << REG_NAMES[(Address >> 2) & 0x3];
		}
		else
		{
			cout << " ERROR";
...
#endif	// end #ifdef ALLOW_VERBOSE_DEBUG_PS1_INTC_READ
	...
	switch ( Address )
	{
		case I_STAT:
			...
			ulOutput = _INTC->I_STAT_Reg.Value;
			break;
		...
		case I_MASK:
			...
			ulOutput = _INTC->I_MASK_Reg.Value;
			break;
...
#ifdef ALLOW_VERBOSE_DEBUG_PS1_INTC_WRITE
	if (bEnableVerboseDebugWrite)
	{
		cout << "\nPS1 INTC WRITE ADDR:0x" << hex << Address;
...
#endif	// end #ifdef ALLOW_VERBOSE_DEBUG_PS1_INTC_WRITE
...
void Intc::DebugWindow_Enable ()
{
	...
	static constexpr const char* DebugWindow_Caption = "PS1 INTC Debug Window";
