...
//#pragma once
#ifndef __PS1DATABUS_H__
#define __PS1DATABUS_H__
...
#define ENABLE_MEMORY_INVALIDATE_DECLARATIONS
...
namespace Playstation1
{
	...
	public:
		...
		static constexpr uint64_t BUS_PS1REG_READ_BIT = 34ull;
		static constexpr uint64_t BUS_PS1REG_READ_BIT_MASK64 = (1ull << BUS_PS1REG_READ_BIT);

		static constexpr uint64_t BUS_PS1REG_WRITE_BIT = 35ull;
		static constexpr uint64_t BUS_PS1REG_WRITE_BIT_MASK64 = (1ull << BUS_PS1REG_WRITE_BIT);

		// sif
		static constexpr uint32_t BUS_PS1REG_GROUP0_START = 0x1d000000;
		static constexpr uint32_t BUS_PS1REG_GROUP0_END = 0x1d001000;
		static constexpr uint32_t BUS_PS1REG_GROUP0_SIZE = BUS_PS1REG_GROUP0_END - BUS_PS1REG_GROUP0_START;
		static constexpr uint32_t BUS_PS1REG_GROUP0_SIZE_MASK = BUS_PS1REG_GROUP0_SIZE - 1;

		// cdvd
		static constexpr uint32_t BUS_PS1REG_GROUP1_START = 0x1f402000;
		static constexpr uint32_t BUS_PS1REG_GROUP1_END = 0x1f403000;
		static constexpr uint32_t BUS_PS1REG_GROUP1_SIZE = BUS_PS1REG_GROUP1_END - BUS_PS1REG_GROUP1_START;
		static constexpr uint32_t BUS_PS1REG_GROUP1_SIZE_MASK = BUS_PS1REG_GROUP1_SIZE - 1;

		// other ps1 device regs - intc, dma, timers, sio, sio2, spu
		static constexpr uint32_t BUS_PS1REG_GROUP2_START = 0x1f800000;
		static constexpr uint32_t BUS_PS1REG_GROUP2_END = 0x1f809000;
		static constexpr uint32_t BUS_PS1REG_GROUP2_SIZE = BUS_PS1REG_GROUP2_END - BUS_PS1REG_GROUP2_START;
		static constexpr uint32_t BUS_PS1REG_GROUP2_SIZE_MASK = BUS_PS1REG_GROUP2_SIZE - 1;

		// spu2
		static constexpr uint32_t BUS_PS1REG_GROUP3_START = 0x1f900000;
		static constexpr uint32_t BUS_PS1REG_GROUP3_END = 0x1f901000;
		static constexpr uint32_t BUS_PS1REG_GROUP3_SIZE = BUS_PS1REG_GROUP3_END - BUS_PS1REG_GROUP3_START;
		static constexpr uint32_t BUS_PS1REG_GROUP3_SIZE_MASK = BUS_PS1REG_GROUP3_SIZE - 1;

		// need to know what addresses belong to R5900 vs R3000A so this will be or'ed with address for R5900
		static constexpr uint64_t BUS_R3000A_TRANSFER_BIT = 33ull;
		static constexpr uint64_t BUS_R3000A_TRANSFER_BIT_MASK64 = (1ull << BUS_R3000A_TRANSFER_BIT);


		static constexpr uint64_t BUS_INVALID_TRANSFER_BIT = 36ull;
		static constexpr uint64_t BUS_INVALID_TRANSFER_BIT_MASK64 = (1ull << BUS_INVALID_TRANSFER_BIT);

		static constexpr uint64_t R3000A_MAIN_MEMORY_CACHED0 = 0x00000000;
		static constexpr uint64_t R3000A_MAIN_MEMORY_CACHED1 = 0x80000000;
		static constexpr uint64_t R3000A_MAIN_MEMORY_UNCACHED0 = 0xa0000000;

		static constexpr uint32_t R3000A_MAIN_MEMORY_SIZE_BYTES = (1 << 21);
		static constexpr uint32_t R3000A_MAIN_MEMORY_SIZE_MASK = R3000A_MAIN_MEMORY_SIZE_BYTES - 1;

		// need to know what addresses R5900 uses for main memory
		static constexpr uint64_t R3000A_MAIN_MEMORY_SECTIONS[] = {
			BUS_R3000A_TRANSFER_BIT_MASK64 | R3000A_MAIN_MEMORY_UNCACHED0,
			BUS_R3000A_TRANSFER_BIT_MASK64 | R3000A_MAIN_MEMORY_CACHED0,
			BUS_R3000A_TRANSFER_BIT_MASK64 | R3000A_MAIN_MEMORY_CACHED1,
		};

		static constexpr uint32_t R3000A_MAIN_MEMORY_PERMISSIONS[] = {
			FILE_MAP_ALL_ACCESS,
			FILE_MAP_ALL_ACCESS,
			FILE_MAP_ALL_ACCESS,
			FILE_MAP_ALL_ACCESS,
		...
		static constexpr uint64_t R3000A_BIOS_MEMORY_CACHED0 = 0x1fc00000;
		static constexpr uint64_t R3000A_BIOS_MEMORY_CACHED1 = 0x9fc00000;
		static constexpr uint64_t R3000A_BIOS_MEMORY_UNCACHED0 = 0xbfc00000;

#ifdef PS2_COMPILE
		static constexpr uint32_t R3000A_BIOS_MEMORY_SIZE_BYTES = (1 << 22);
#else
		static constexpr uint32_t R3000A_BIOS_MEMORY_SIZE_BYTES = (1 << 19);
#endif

		static constexpr uint32_t R3000A_BIOS_MEMORY_SIZE_MASK = R3000A_BIOS_MEMORY_SIZE_BYTES - 1;

		static constexpr uint64_t R3000A_BIOS_MEMORY_SECTIONS[] = {
			BUS_R3000A_TRANSFER_BIT_MASK64 | R3000A_BIOS_MEMORY_CACHED0,
			BUS_R3000A_TRANSFER_BIT_MASK64 | R3000A_BIOS_MEMORY_CACHED1,
			BUS_R3000A_TRANSFER_BIT_MASK64 | R3000A_BIOS_MEMORY_UNCACHED0,
		};

		static constexpr uint32_t R3000A_BIOS_MEMORY_PERMISSIONS[] = {
			FILE_MAP_ALL_ACCESS,
			FILE_MAP_ALL_ACCESS,
			FILE_MAP_ALL_ACCESS,
		};
		...
		static constexpr uint64_t R3000A_SCRATCHPAD_MEMORY_UNCACHED0 = 0x1f800000;

		static constexpr uint32_t R3000A_SCRATCHPAD_MEMORY_SIZE_BYTES = (1 << 10);
		static constexpr uint32_t R3000A_SCRATCHPAD_MEMORY_SIZE_MASK = R3000A_SCRATCHPAD_MEMORY_SIZE_BYTES - 1;

		static constexpr uint64_t R3000A_SCRATCHPAD_MEMORY_SECTIONS[] = {
			BUS_R3000A_TRANSFER_BIT | R3000A_SCRATCHPAD_MEMORY_UNCACHED0,
		};

		static constexpr uint32_t R3000A_SCRATCHPAD_MEMORY_PERMISSIONS[] = {
			FILE_MAP_ALL_ACCESS,
		};
...
#ifdef ENABLE_MEMORY_INVALIDATE_DECLARATIONS
		...
		// changing the main memory and bios to be pointers so they can point to where ever
		static MemoryPtr_Format MainMemory;
		static MemoryPtr_Format BIOS;
		
		// this will be the actual non-virtual physical memory locations for when saving state
...
#endif	// end #ifndef __PS1DATABUS_H__
