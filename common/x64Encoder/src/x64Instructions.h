...
//#pragma once
#ifndef __X64INSTRUCTIONS_H__
#define __X64INSTRUCTIONS_H__
...
// rounding values for b-bit to enable/disable static rounding
#define EVEX_DISABLE_STATIC_ROUNDING    0
#define EVEX_ENABLE_STATIC_ROUNDING     1

// rounding values for L'L in AVX-512 evex prefix
#define EVEX_ROUND_NEAREST   0
#define EVEX_ROUND_DOWN      1
#define EVEX_ROUND_UP        2
#define EVEX_ROUND_ZERO      3
...
constexpr int32_t EAX = 0;
constexpr int32_t ECX = 1;
constexpr int32_t EDX = 2;
constexpr int32_t EBX = 3;
constexpr int32_t ESP = 4;
constexpr int32_t EBP = 5;
constexpr int32_t ESI = 6;
// this causes a conflict with R5900 recompiler
//constexpr uint32_t EDI = 7;

constexpr int32_t RAX = 0;
constexpr int32_t RCX = 1;
constexpr int32_t RDX = 2;
constexpr int32_t RBX = 3;
constexpr int32_t RSP = 4;
constexpr int32_t RBP = 5;
constexpr int32_t RSI = 6;
constexpr int32_t RDI = 7;
...
constexpr int32_t MM0 = 0;
constexpr int32_t MM1 = 1;
constexpr int32_t MM2 = 2;
constexpr int32_t MM3 = 3;
constexpr int32_t MM4 = 4;
constexpr int32_t MM5 = 5;
constexpr int32_t MM6 = 6;
constexpr int32_t MM7 = 7;

constexpr int32_t XMM0 = 0;
constexpr int32_t XMM1 = 1;
constexpr int32_t XMM2 = 2;
constexpr int32_t XMM3 = 3;
constexpr int32_t XMM4 = 4;
constexpr int32_t XMM5 = 5;
constexpr int32_t XMM6 = 6;
constexpr int32_t XMM7 = 7;

constexpr int32_t XMM8 = 8;
constexpr int32_t XMM9 = 9;
constexpr int32_t XMM10 = 10;
constexpr int32_t XMM11 = 11;
constexpr int32_t XMM12 = 12;
constexpr int32_t XMM13 = 13;
constexpr int32_t XMM14 = 14;
constexpr int32_t XMM15 = 15;
...
#define EVEX_4BYTE_P0(R,X,B,mm)		( ( ( ( ~( R ) ) & 0x8 ) << 4 ) | ( ( ( ~( X ) ) & 0x10 ) << 2 ) | ( ( ( ~( B ) ) & 0x8 ) << 2 ) | ( ( ( ~( R ) ) & 0x10 ) << 0 ) | ( mm & 0x3 ) )
#define EVEX_4BYTE_P1(W,vvvv,pp)	( ( ( ( ( W ) ) & 0x1 ) << 7 ) | ( ( ( ~( vvvv ) ) & 0xf ) << 3 ) | ( ( 0x1 ) << 2 ) | ( pp & 0x3 ) )
#define EVEX_4BYTE_P2(z,L,b,vvvv,k)	( ( ( ( ( z ) ) & 0x1 ) << 7 ) | ( ( ( ( L ) ) & 0x3 ) << 5 ) | ( ( ( ( b ) ) & 0x1 ) << 4 ) | ( ( ( ~( vvvv ) ) & 0x10 ) >> 1 ) | ( k & 0x7 ) )

// these are for mmmmm or mm
...
#define VEX_3BYTE_END(W,vvvv,L,pp)	( ( ( ( ( W ) ) & 0x1 ) << 7 ) | ( ( ( ~( vvvv ) ) & 0xf ) << 3 ) | ( ( L ) << 2 ) | ( pp ) )
...
// JO rel32
#define X64OP1_JMP_O			0x0f
#define X64OP2_JMP_O			0x80
...
// JS rel32
#define X64OP1_JMP_S			0x0f
#define X64OP2_JMP_S			0x88

// JNS rel32
#define X64OP1_JMP_NS			0x0f
#define X64OP2_JMP_NS			0x89
...
// CMOVO r32, r/m32
// CMOVO r64, r/m64
#define X64OP1_CMOVO		0x0f
#define X64OP2_CMOVO		0x40
...
// cmp 8-bit immediate 8-bit (if using rex prefix, then can't use regs a,b,c,d)
// CMP r/m8, imm8
#define X64OP_CMP8_IMM8		0x80
#define MODRM_CMP8_IMM8		0x7
...
// cmp immedate to Accumulator 8-bit
// CMP AX, imm8
#define X64OP_CMP8_IMMA		0x3c
...
// RCR r/m32, 1
// RCR r/m16, 1
#define X64OP_RCR_1	    	0xd1
#define MODRM_RCR_1 		0x3
...
// r64 = r64 - r/m64 - borrow
// SBB r64, r/m64
// SBB r32, r/m32
#define X64OP_SBB			0x1b


// Subtract immediate 8-bit with borrow
// SBB r/m64, imm8
// SBB r/m32, imm8
// SBB r/m16, imm8
#define X64OP_SBB_IMM8		0x83
#define MODRM_SBB_IMM8		0x3
...
// convert with single single-precision float to single double-precision float
// F3 0F 5A /r
// CVTSS2SD xmm1, xmm2/m32
#define X64OP1_CVTSS2SD 	0x0f
#define X64OP2_CVTSS2SD	    0x5a
...
// VBLENDVPS - blend packed 32-bit values
// VBLENDVPS xmm1, xmm2, xmm3/m128, xmm4
// VEX.NDS.128.66.0F3A.W0 4A /r ib
#define AVXOP_BLENDVPS			0x4a
#define PP_BLENDVPS				VEX_PREFIX66
#define MMMMM_BLENDVPS			VEX_PREFIX0F3A
...
// VBLENDVPD ymm1, ymm2, ymm3/m256, ymm4
// VEX.NDS.256.66.0F3A.W0 4B /r ib
// VBLENDVPD ymm1, ymm2, ymm3/m256, ymm4
#define AVXOP_BLENDVPD			0x4b
#define PP_BLENDVPD				VEX_PREFIX66
#define MMMMM_BLENDVPD			VEX_PREFIX0F3A
...
#define AVXOP_MOVMSKB			0xd7
#define PP_MOVMSKB				VEX_PREFIX66
#define MMMMM_MOVMSKB			VEX_PREFIX0F
...
#define AVXOP_MOVMSKPD			0x50
#define PP_MOVMSKPD				VEX_PREFIX66
#define MMMMM_MOVMSKPD			VEX_PREFIX0F
...
// vpblendmd - avx512 32-bit double-word blend using mask register
#define AVXOP_VPBLENDMD			0x64

// vpblendmq - avx512 64-bit quad-word blend using mask register
#define AVXOP_VPBLENDMQ			0x64

// vpternlogd - avx512 32bit ternary op
#define AVXOP_VPTERNLOGD		0x25
...
// VPACKSDW - pack 32-bit values into 16-bit values using signed saturation - source 1 on bottom
// VPACKSDW xmm1, xmm2, xmm3/m128
// VEX.NDS.128.66.0F.WIG 6B /r
#define AVXOP_PACKSDW			0x6b

// VPACKUSWB - pack 16-bit values into 8-bit values using signed saturation - source 1 on bottom
// VPACKUSWB xmm1, xmm2, xmm3/m128
// VEX.NDS.128.66.0F.WIG 63 /r
#define AVXOP_PACKSWB			0x63
...
// VPADDQ - add packed 64-bit values
// VPADDQ xmm1, xmm2, xmm3/m128
// VEX.NDS.128.66.0F.WIG D4 /r
#define AVXOP_PADDQ				0xd4
...
// VPCMPD - compare signed packed double-words
#define AVXOP_PMAXUD            0x3f


// VPCMPD - compare signed packed double-words
#define AVXOP_VPCMPD            0x1f

// VPCMPUD - compare unsigned packed double-words
#define AVXOP_VPCMPUD            0x1e
...
// VPMINUD - get minimum of packed unsigned 32-bit values
#define AVXOP_PMINUD			0x3b
...
#define AVXOP_PSLLQ_IMM				0x73
#define MODRM_PSLLQ_IMM				0x6
...
// VPSRAQ xmm1, xmm2, imm8
#define AVXOP_PSRAQ_IMM				0x72
#define MODRM_PSRAQ_IMM				0x4
...
#define AVXOP_PSRLQ_IMM			0x73
#define MODRM_PSRLQ_IMM			0x2
...
// VPSUBD - subtract packed 64-bit values
#define AVXOP_PSUBQ					0xfb
...
#endif  // end #ifndef __X64INSTRUCTIONS_H__
