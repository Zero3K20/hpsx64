...
using namespace std;
	...
	public:
		...
		*/
		...
		// *** Dialog Boxes *** //
		string ShowFileOpenDialog (const char* sFileFilter = "All\0*.*\0");
		...
		inline void OpenGL_MakeCurrentWindow () { if(hRC) wglMakeCurrent( hDC, hRC ); }
...
*/
	...
	public:
		...
		inline static LPLVITEM CreateItem ( int row, int column, const char* text )
		{
...
#endif	// end #ifndef __WINAPIHANDLER_H__
