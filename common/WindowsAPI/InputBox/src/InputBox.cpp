...
void InputBox::ShowDialog ( WindowClass::Window* ParentWindow, string WindowCaption, string Prompt, InputBoxCallback _OnClick_Ok, InputBoxCallback _OnClick_Cancel, const char* InitialValue )
{
	...
	static constexpr const char* Dialog1_Caption = "Modify";
	...
	static constexpr const char* Label1_Text = "Enter new value:";
	...
	static constexpr const char* CmdButton1_Caption = "OK";
	...
	static constexpr const char* CmdButton2_Caption = "Cancel";
