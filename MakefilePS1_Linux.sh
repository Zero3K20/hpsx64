#!/bin/bash
# MakefilePS1_Linux.sh - Build script for hps1x64 (PS1 emulator) on Linux/Steam Deck
# Usage: ./MakefilePS1_Linux.sh [clean]
...
make -f MakefilePS1_Linux.txt "$@"
echo ""
echo "Build complete: hps1x64"
