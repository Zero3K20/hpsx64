...
#define ALLOW_VERBOSE_DEBUG_PS2_SIF_IOP_READ
#define ALLOW_VERBOSE_DEBUG_PS2_SIF_IOP_WRITE
#define ALLOW_VERBOSE_DEBUG_PS2_SIF_EE_READ
#define ALLOW_VERBOSE_DEBUG_PS2_SIF_EE_WRITE
...
bool SIF::bEnableVerboseDebugRead;
bool SIF::bEnableVerboseDebugWrite;
...
#ifdef ALLOW_VERBOSE_DEBUG_PS2_SIF_EE_READ
	if (bEnableVerboseDebugRead)
	{
		cout << "\nPS2 SIF READ ADDR:0x" << hex << Address;

		if ((Address & 0xffff) < 0xf270)
		{
			cout << " " << REG_NAMES_EE[(Address >> 4) & 0x7];
		}
		else
		{
			cout << " ERROR";
...
#endif	// end #ifdef ALLOW_VERBOSE_DEBUG_PS2_SIF_EE_READ
...
#ifdef ALLOW_VERBOSE_DEBUG_PS2_SIF_EE_WRITE
	if (bEnableVerboseDebugWrite)
	{
		cout << "\nPS2 SIF WRITE ADDR:0x" << hex << Address;
...
#endif	// end #ifdef ALLOW_VERBOSE_DEBUG_PS2_SIF_EE_WRITE
...
#ifdef ALLOW_VERBOSE_DEBUG_PS2_SIF_IOP_READ
	if (bEnableVerboseDebugRead)
	{
		cout << "\nPS2 SIF READ ADDR:0x" << hex << Address;

		if ((Address & 0xffff) < 0x0070)
		{
			cout << " " << REG_NAMES_IOP[(Address >> 4) & 0x7];
		}
		else
		{
			cout << " ERROR";
...
#endif	// end #ifdef ALLOW_VERBOSE_DEBUG_PS2_SIF_IOP_READ
...
#ifdef ALLOW_VERBOSE_DEBUG_PS2_SIF_IOP_WRITE
	if (bEnableVerboseDebugWrite)
	{
		cout << "\nPS2 SIF WRITE ADDR:0x" << hex << Address;
...
#endif	// end #ifdef ALLOW_VERBOSE_DEBUG_PS2_SIF_IOP_WRITE
