...
//#pragma once
#ifndef __PS2DATABUS_H__
#define __PS2DATABUS_H__
...
namespace Playstation2
{
	...
	public:
		...
		static char* pRamVirtual;
		static char* pBiosVirtual;
		static char* pScratchPadVirtual;
		...
		static const int c_iRAM_Read_Latency = 20;	//14;
		...
		static constexpr uint64_t BUS_PS2REG_READ_BIT = 38ull;
		static constexpr uint64_t BUS_PS2REG_READ_BIT_MASK64 = (1ull << BUS_PS2REG_READ_BIT);

		static constexpr uint64_t BUS_PS2REG_WRITE_BIT = 39ull;
		static constexpr uint64_t BUS_PS2REG_WRITE_BIT_MASK64 = (1ull << BUS_PS2REG_WRITE_BIT);

		// starting and ending points for mapping the ps2 reg groups
		static constexpr uint32_t BUS_PS2REG_GROUP0_START = 0x10000000;
		static constexpr uint32_t BUS_PS2REG_GROUP0_END = 0x10010000;
		static constexpr uint32_t BUS_PS2REG_GROUP0_SIZE = BUS_PS2REG_GROUP0_END - BUS_PS2REG_GROUP0_START;
		static constexpr uint32_t BUS_PS2REG_GROUP0_SIZE_MASK = BUS_PS2REG_GROUP0_SIZE - 1;

		// privileged gs regs
		static constexpr uint32_t BUS_PS2REG_GROUP1_START = 0x12000000;
		static constexpr uint32_t BUS_PS2REG_GROUP1_END = 0x12010000;
		static constexpr uint32_t BUS_PS2REG_GROUP1_SIZE = BUS_PS2REG_GROUP1_END - BUS_PS2REG_GROUP1_START;
		static constexpr uint32_t BUS_PS2REG_GROUP1_SIZE_MASK = BUS_PS2REG_GROUP1_SIZE - 1;

		// vu memory
		static constexpr uint32_t BUS_PS2REG_VUMEMORY_START = 0x11000000;
		static constexpr uint32_t BUS_PS2REG_VUMEMORY_END = 0x11010000;
		static constexpr uint32_t BUS_PS2REG_VUMEMORY_SIZE = BUS_PS2REG_VUMEMORY_END - BUS_PS2REG_VUMEMORY_START;
		static constexpr uint32_t BUS_PS2REG_VUMEMORY_SIZE_MASK = BUS_PS2REG_VUMEMORY_SIZE - 1;

		static constexpr uint32_t BUS_PS2REG_MICROMEM0_START = 0x11000000;
		static constexpr uint32_t BUS_PS2REG_MICROMEM0_END = 0x11001000;
		static constexpr uint32_t BUS_PS2REG_MICROMEM0_MIRROR_START = 0x11001000;
		static constexpr uint32_t BUS_PS2REG_MICROMEM0_MIRROR_END = 0x11004000;
		static constexpr uint32_t BUS_PS2REG_MICROMEM0_SIZE = BUS_PS2REG_MICROMEM0_END - BUS_PS2REG_MICROMEM0_START;
		static constexpr uint32_t BUS_PS2REG_MICROMEM0_SIZE_MASK = BUS_PS2REG_MICROMEM0_SIZE - 1;

		static constexpr uint32_t BUS_PS2REG_VUMEM0_START = 0x11004000;
		static constexpr uint32_t BUS_PS2REG_VUMEM0_END = 0x11005000;
		static constexpr uint32_t BUS_PS2REG_VUMEM0_MIRROR_START = 0x11005000;
		static constexpr uint32_t BUS_PS2REG_VUMEM0_MIRROR_END = 0x11008000;
		static constexpr uint32_t BUS_PS2REG_VUMEM0_SIZE = BUS_PS2REG_VUMEM0_END - BUS_PS2REG_VUMEM0_START;
		static constexpr uint32_t BUS_PS2REG_VUMEM0_SIZE_MASK = BUS_PS2REG_VUMEM0_SIZE - 1;

		static constexpr uint32_t BUS_PS2REG_MICROMEM1_START = 0x11008000;
		static constexpr uint32_t BUS_PS2REG_MICROMEM1_END = 0x1100c000;
		static constexpr uint32_t BUS_PS2REG_MICROMEM1_SIZE = BUS_PS2REG_MICROMEM1_END - BUS_PS2REG_MICROMEM1_START;
		static constexpr uint32_t BUS_PS2REG_MICROMEM1_SIZE_MASK = BUS_PS2REG_MICROMEM1_SIZE - 1;

		static constexpr uint32_t BUS_PS2REG_VUMEM1_START = 0x1100c000;
		static constexpr uint32_t BUS_PS2REG_VUMEM1_END = 0x11010000;
		static constexpr uint32_t BUS_PS2REG_VUMEM1_SIZE = BUS_PS2REG_VUMEM1_END - BUS_PS2REG_VUMEM1_START;
		static constexpr uint32_t BUS_PS2REG_VUMEM1_SIZE_MASK = BUS_PS2REG_VUMEM1_SIZE - 1;

		// need to know what addresses belong to R5900 vs R3000A so this will be or'ed with address for R5900
		static constexpr uint64_t BUS_R5900_TRANSFER_BIT = 37ull;
		static constexpr uint64_t BUS_R5900_TRANSFER_BIT_MASK64 = (1ull << BUS_R5900_TRANSFER_BIT);

		static constexpr uint64_t R5900_MAIN_MEMORY_CACHED0 = 0x00000000;
		static constexpr uint64_t R5900_MAIN_MEMORY_UNCACHED0 = 0x20000000;
		static constexpr uint64_t R5900_MAIN_MEMORY_ACCELERATED0 = 0x30000000;
		static constexpr uint64_t R5900_MAIN_MEMORY_CACHED1 = 0x80000000;
		static constexpr uint64_t R5900_MAIN_MEMORY_UNCACHED1 = 0xa0000000;

		static constexpr uint32_t R5900_MAIN_MEMORY_SIZE_BYTES = (1 << 25);
		static constexpr uint32_t R5900_MAIN_MEMORY_SIZE_MASK = R5900_MAIN_MEMORY_SIZE_BYTES - 1;

		// need to know what addresses R5900 uses for main memory
		static constexpr uint64_t R5900_MAIN_MEMORY_SECTIONS[] = {
			BUS_R5900_TRANSFER_BIT_MASK64 | R5900_MAIN_MEMORY_UNCACHED0,
			BUS_R5900_TRANSFER_BIT_MASK64 | R5900_MAIN_MEMORY_CACHED0,
			BUS_R5900_TRANSFER_BIT_MASK64 | R5900_MAIN_MEMORY_ACCELERATED0,
			BUS_R5900_TRANSFER_BIT_MASK64 | R5900_MAIN_MEMORY_CACHED1,
			BUS_R5900_TRANSFER_BIT_MASK64 | R5900_MAIN_MEMORY_UNCACHED1,
		};

		static constexpr uint32_t R5900_MAIN_MEMORY_PERMISSIONS[] = {
			FILE_MAP_ALL_ACCESS,
			FILE_MAP_ALL_ACCESS,
			FILE_MAP_ALL_ACCESS,
			FILE_MAP_ALL_ACCESS,
		...
		static constexpr uint64_t R5900_BIOS_MEMORY_UNCACHED0 = 0x1fc00000;
		static constexpr uint64_t R5900_BIOS_MEMORY_CACHED0 = 0x9fc00000;
		static constexpr uint64_t R5900_BIOS_MEMORY_UNCACHED1 = 0xbfc00000;

		static constexpr uint32_t R5900_BIOS_MEMORY_SIZE_BYTES = (1 << 22);
		static constexpr uint32_t R5900_BIOS_MEMORY_SIZE_MASK = R5900_BIOS_MEMORY_SIZE_BYTES - 1;

		static constexpr uint64_t R5900_BIOS_MEMORY_SECTIONS[] = {
			BUS_R5900_TRANSFER_BIT_MASK64 | R5900_BIOS_MEMORY_UNCACHED0,
			BUS_R5900_TRANSFER_BIT_MASK64 | R5900_BIOS_MEMORY_CACHED0,
			BUS_R5900_TRANSFER_BIT_MASK64 | R5900_BIOS_MEMORY_UNCACHED1,
		};

		static constexpr uint32_t R5900_BIOS_MEMORY_PERMISSIONS[] = {
			FILE_MAP_ALL_ACCESS,
			FILE_MAP_ALL_ACCESS,
			FILE_MAP_ALL_ACCESS,
		};
		...
		static constexpr uint64_t R5900_SCRATCHPAD_MEMORY_UNCACHED0 = 0x70000000;

		static constexpr uint32_t R5900_SCRATCHPAD_MEMORY_SIZE_BYTES = (1 << 14);
		static constexpr uint32_t R5900_SCRATCHPAD_MEMORY_SIZE_MASK = R5900_SCRATCHPAD_MEMORY_SIZE_BYTES - 1;

		static constexpr uint64_t R5900_SCRATCHPAD_MEMORY_SECTIONS[] = {
			BUS_R5900_TRANSFER_BIT_MASK64 | R5900_SCRATCHPAD_MEMORY_UNCACHED0,
		};

		static constexpr uint32_t R5900_SCRATCHPAD_MEMORY_PERMISSIONS[] = {
			FILE_MAP_ALL_ACCESS,
		};


		// the views associated with memory ranges
		std::vector<void*> pMainMemoryViews;
		std::vector<void*> pBiosMemoryViews;
		std::vector<void*> pScratchPadMemoryViews;
		...
		// call this before saving state so that virtual memory gets copied to physical first
		void SaveVirtualState();

		// call this after loading a state to restore physical memory to virtual memory
		void RestoreVirtualState();
		...
		static MemoryPtr_Format ScratchPad;

		_MainMemory PhyMainMemory;
		_BIOS PhyBIOS;
		_ScratchPad PhyScratchPad;
...
#endif	// end #ifndef __PS2DATABUS_H__
