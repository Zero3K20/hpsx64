...
namespace Playstation2
{
	...
	public:
		...
		static constexpr const char* ProgramWindow_Caption = "hps2x64";
		static constexpr const char* ProgramWindow_Caption_OpenGL_Loaded = "hps2x64   *** OPENGL LOADED ***";
		static constexpr const char* ProgramWindow_Caption_Vulkan_Loaded = "hps2x64   *** VULKAN LOADED ***";

		static WindowClass::Window* ProgramWindow;

		static std::unique_ptr<OpenGLWindow> m_prgwindow;
		...
		static int iWindowType;
		enum { WINDOW_TYPE_NONE = 0, WINDOW_TYPE_OPENGL, WINDOW_TYPE_VULKAN };

		static bool CreateOpenGLWindow();
		static bool CreateVulkanWindow();
	...
	public:
		...
		// map the callback functions for the interface
		void map_callback_functions();
		...
		void RunProgram();
		inline void RunProgram_Normal();
		inline void RunProgram_Normal_VirtualMachine();
		...
		static void OnClick_Debug_Console_PS1_DMA_READ(int i);
		static void OnClick_Debug_Console_PS1_DMA_WRITE(int i);

		static void OnClick_Debug_Console_PS1_INTC_READ(int i);
		static void OnClick_Debug_Console_PS1_INTC_WRITE(int i);

		static void OnClick_Debug_Console_PS1_TIMER_READ(int i);
		static void OnClick_Debug_Console_PS1_TIMER_WRITE(int i);


		static void OnClick_Debug_Console_PS2_DMA_READ(int i);
		static void OnClick_Debug_Console_PS2_DMA_WRITE(int i);

		static void OnClick_Debug_Console_PS2_INTC_READ(int i);
		static void OnClick_Debug_Console_PS2_INTC_WRITE(int i);

		static void OnClick_Debug_Console_PS2_TIMER_READ(int i);
		static void OnClick_Debug_Console_PS2_TIMER_WRITE(int i);


		static void OnClick_Debug_SaveConsole(int i);
		...
		static void OnClick_Video_Renderer_Software_OpenGL(int i);
		static void OnClick_Video_Renderer_Software_Vulkan(int ShaderThreads);
		static void OnClick_Video_Renderer_Hardware_Vulkan(int i);
		static void OnClick_Video_Renderer_Hardware1_Vulkan(int i);
		static void OnClick_Video_Renderer_Hardware2_Vulkan(int i);
		static void OnClick_Video_Renderer_Hardware4_Vulkan(int i);
		static void OnClick_Video_Renderer_Hardware8_Vulkan(int i);
		...
		static void OnClick_Video_DisplayMode_Stretch(int i);
		static void OnClick_Video_DisplayMode_Fit(int i);
		...
		static void LoadGamepadConfig(int deviceIndex);
		static void ApplyGamepadConfig(int deviceIndex);

	private:
		static GamepadConfigWindow::GamepadConfig m_gamepadConfig;
	};
