...
//#define VERBOSE_PS2SYSTEM_START
...
#ifdef VERBOSE_PS2SYSTEM_START

	cout << "\nHPS2X64: INFO: PS2SYSTEM started.";
	cout << "\n\t PS2 object sizes:";
	cout << "\n\t\t CPU:" << sizeof(_CPU);
	cout << "\n\t\t TIMERS:" << sizeof(_TIMERS);
	cout << "\n\t\t GPU:" << sizeof(_GPU);
	cout << "\n\t\t DMA:" << sizeof(_DMA);
	cout << "\n\t\t INTC:" << sizeof(_INTC);
	cout << "\n\t\t SIF:" << sizeof(_SIF);
...
//#define USE_NEW_PS2_SYSTEM_GET_NEXT_EVENT_CYCLE
#ifdef USE_NEW_PS2_SYSTEM_GET_NEXT_EVENT_CYCLE

	//if (_DMA.NextEvent_Cycle < NextEvent_Cycle) { NextEvent_Cycle = _DMA.NextEvent_Cycle; NextEvent_Idx = _DMA.NextEvent_Idx; }
	NextEvent_Idx = (_DMA.NextEvent_Cycle < NextEvent_Cycle) ? _DMA.NextEvent_Idx : NextEvent_Idx;
	NextEvent_Cycle = (_DMA.NextEvent_Cycle < NextEvent_Cycle) ? _DMA.NextEvent_Cycle : NextEvent_Cycle;

	//if (_TIMERS.NextEvent_Cycle < NextEvent_Cycle) { NextEvent_Cycle = _TIMERS.NextEvent_Cycle; NextEvent_Idx = _TIMERS.NextEvent_Idx; }
	NextEvent_Idx = (_TIMERS.NextEvent_Cycle < NextEvent_Cycle) ? _TIMERS.NextEvent_Idx : NextEvent_Idx;
	NextEvent_Cycle = (_TIMERS.NextEvent_Cycle < NextEvent_Cycle) ? _TIMERS.NextEvent_Cycle : NextEvent_Cycle;

	//if (_GPU.NextEvent_Cycle < NextEvent_Cycle) { NextEvent_Cycle = _GPU.NextEvent_Cycle; NextEvent_Idx = _GPU.NextEvent_Idx; }
	NextEvent_Idx = (_GPU.NextEvent_Cycle < NextEvent_Cycle) ? _GPU.NextEvent_Idx : NextEvent_Idx;
	NextEvent_Cycle = (_GPU.NextEvent_Cycle < NextEvent_Cycle) ? _GPU.NextEvent_Cycle : NextEvent_Cycle;

	//if (_SIF.NextEvent_Cycle < NextEvent_Cycle) { NextEvent_Cycle = _SIF.NextEvent_Cycle; NextEvent_Idx = _SIF.NextEvent_Idx; }
	NextEvent_Idx = (_SIF.NextEvent_Cycle < NextEvent_Cycle) ? _SIF.NextEvent_Idx : NextEvent_Idx;
	NextEvent_Cycle = (_SIF.NextEvent_Cycle < NextEvent_Cycle) ? _SIF.NextEvent_Cycle : NextEvent_Cycle;

	//if (_IPU.NextEvent_Cycle < NextEvent_Cycle) { NextEvent_Cycle = _IPU.NextEvent_Cycle; NextEvent_Idx = _IPU.NextEvent_Idx; }
	NextEvent_Idx = (_IPU.NextEvent_Cycle < NextEvent_Cycle) ? _IPU.NextEvent_Idx : NextEvent_Idx;
	NextEvent_Cycle = (_IPU.NextEvent_Cycle < NextEvent_Cycle) ? _IPU.NextEvent_Cycle : NextEvent_Cycle;

	//if (_VU0.VU0.CycleCount < NextEvent_Cycle) { NextEvent_Cycle = _VU0.VU0.CycleCount; NextEvent_Idx = _VU0.VU0.NextEvent_Idx; }
	NextEvent_Idx = (_VU0.VU0.CycleCount < NextEvent_Cycle) ? _VU0.VU0.NextEvent_Idx : NextEvent_Idx;
	NextEvent_Cycle = (_VU0.VU0.CycleCount < NextEvent_Cycle) ? _VU0.VU0.CycleCount : NextEvent_Cycle;
	...
	NextEvent_Idx = (_VU1.VU1.eCycleCount < NextEvent_Cycle) ? _VU1.VU1.NextEvent_Idx : NextEvent_Idx;
	NextEvent_Cycle = (_VU1.VU1.eCycleCount < NextEvent_Cycle) ? _VU1.VU1.eCycleCount : NextEvent_Cycle;

	// *todo* this only looks at r3000a cyclecount? What about when ps1 needs to run the next event?
	...
	NextEvent_Idx = ((_PS1SYSTEM._CPU.CycleCount << 2) < NextEvent_Cycle) ? _PS1SYSTEM.NextEvent_Idx2 : NextEvent_Idx;
	NextEvent_Cycle = ((_PS1SYSTEM._CPU.CycleCount << 2) < NextEvent_Cycle) ? (_PS1SYSTEM._CPU.CycleCount << 2) : NextEvent_Cycle;
#else
	if ( _DMA.NextEvent_Cycle < NextEvent_Cycle ) { NextEvent_Cycle = _DMA.NextEvent_Cycle; NextEvent_Idx = _DMA.NextEvent_Idx; }
	if ( _TIMERS.NextEvent_Cycle < NextEvent_Cycle ) { NextEvent_Cycle = _TIMERS.NextEvent_Cycle; NextEvent_Idx = _TIMERS.NextEvent_Idx; }
	if ( _GPU.NextEvent_Cycle < NextEvent_Cycle ) { NextEvent_Cycle = _GPU.NextEvent_Cycle; NextEvent_Idx = _GPU.NextEvent_Idx; }
