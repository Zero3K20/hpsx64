...
alignas(32) u8 Lookup::LookupTableLO [c_iLookupTableLO_Size];
alignas(32) u8 Lookup::LookupTableHI [c_iLookupTableHI_Size];


// I don't see the upper instruction 0x8000033c, but it seems to be a NOP
#define ENABLE_UPPER_8000033c_AS_NOP
...
#ifdef ENABLE_UPPER_8000033c_AS_NOP
{ "NOP??",		ANY_VALUE,		0x0c,			0x3c,			IDX_NOP },
#endif
...
void Lookup::Start ()
{
	...
	//LookupTableLO = new unsigned char[c_iLookupTableLO_Size];
	//LookupTableHI = new unsigned char[c_iLookupTableHI_Size];
	...
	for ( Index = 0; Index < (c_iLookupTableLO_Size >> 3 ); Index++ ) ((u64*)LookupTableLO) [ Index ] = 0;
	...
	for ( Index = 0; Index < (c_iLookupTableHI_Size >> 3 ); Index++ ) ((u64*)LookupTableHI) [ Index ] = 0;
