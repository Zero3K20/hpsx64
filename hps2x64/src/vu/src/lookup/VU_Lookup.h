...
//#pragma once
#ifndef __VU_LOOKUP_H__
#define __VU_LOOKUP_H__
...
namespace Vu
{
	...
	namespace Instruction
	{
		...
		public:
			...
			// call this when not using the lookup table, then call start again before using
			//static void Stop();
...
#endif	// end #ifndef __VU_LOOKUP_H__
