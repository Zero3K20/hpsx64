...
// update q flag/reg as needed instead of every cycle
// used in VU_Recompiler.cpp, VU_Execute.cpp, VU_Execute.h


// enable async q when advancing cycle
#define ENABLE_ASYNC_QFLAG_INTERPRET_ADVANCE_CYCLE

//#define INLINE_DEBUG_QFLAG

// enable async q when operating on q register
#define ENABLE_ASYNC_QFLAG_INTERPRET_QOP0
#define ENABLE_ASYNC_QFLAG_INTERPRET_QOP1
#define ENABLE_ASYNC_QFLAG_INTERPRET_QOP2
#define ENABLE_ASYNC_QFLAG_INTERPRET_QOP3

// enable async q for fseq interpreter
#define ENABLE_ASYNC_QFLAG_INTERPRET_FSEQ

// enable async q for fsset interpreter
#define ENABLE_ASYNC_QFLAG_INTERPRET_FSSET

// enable async q for fsand interpreter
#define ENABLE_ASYNC_QFLAG_INTERPRET_FSAND

// enable async q for fsor interpreter
#define ENABLE_ASYNC_QFLAG_INTERPRET_FSOR

// general async q flag
#define ENABLE_ASYNC_QFLAG


// only save flag history if it might get checked when recompiling
#define OPTIMIZE_FLAG_HISTORY_STAT
#define OPTIMIZE_FLAG_HISTORY_MAC
#define OPTIMIZE_FLAG_HISTORY_CLIP
...
// -------------------------------------------
			...
			static constexpr unsigned long vec_mask8_lut[16] = { 0x00000000, 0x000000ff, 0x0000ff00, 0x0000ffff,
														0x00ff0000, 0x00ff00ff, 0x00ffff00, 0x00ffffff,
														0xff000000, 0xff0000ff, 0xff00ff00, 0xff00ffff,
														0xffff0000, 0xffff00ff, 0xffffff00, 0xffffffff };
			
			static constexpr unsigned long vec_mask8_rev_lut[16] = { 0x00000000, 0xff000000, 0x00ff0000, 0xffff0000,
			...
			static void Execute_LoadDelaySlot_MacroMode(VU* v, Instruction::Format i);


			static void EXECUTE_PS2_DOUBLE_ABS_PACKED_AVX2(VU* v, Vu::Instruction::Format i);

			template<const int FTCOMP = 0x1b>
			static void EXECUTE_PS2_DOUBLE_MIN_PACKED_AVX2(VU* v, Vu::Instruction::Format i, u32* pFt = nullptr);

			template<const int FTCOMP = 0x1b>
			static void EXECUTE_PS2_DOUBLE_MAX_PACKED_AVX2(VU* v, Vu::Instruction::Format i, u32* pFt = nullptr);

			template<const int FP>
			static void EXECUTE_PS2_DOUBLE_ITOF_PACKED_AVX2(VU* v, Vu::Instruction::Format i);

			template<const int FP>
			static void EXECUTE_PS2_DOUBLE_FTOI_PACKED_AVX2(VU* v, Vu::Instruction::Format i);



			template<const int ACCUM = false, const int FTCOMP = 0x1b, const int FSCOMP = 0x1b>
			static void EXECUTE_PS2_DOUBLE_MUL_PACKED_AVX2(VU* v, Vu::Instruction::Format i, u32* pFt = nullptr);

			template<const int BSUB = false, const int ACCUM = false, const int FTCOMP = 0x1b, const int FSCOMP = 0x1b>
			static void EXECUTE_PS2_DOUBLE_ADD_PACKED_AVX2(VU* v, Vu::Instruction::Format i, u32* pFt = nullptr);

			template<const int BSUB = false, const int ACCUM = false, const int FTCOMP = 0x1b, const int FSCOMP = 0x1b>
			static void EXECUTE_PS2_DOUBLE_MADD_PACKED_AVX2(VU* v, Vu::Instruction::Format i, u32* pFt = nullptr);
			...
			static void VMFIR(VU* v, Instruction::Format i);
			...
			static void VRGET(VU* v, Instruction::Format i);
			static void VRNEXT(VU* v, Instruction::Format i);
