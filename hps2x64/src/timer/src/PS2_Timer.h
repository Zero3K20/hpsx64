...
//#pragma once
#ifndef __PS2_TIMER_H__
#define __PS2_TIMER_H__
...
namespace Playstation2
{
	...
	public:
		...
		static uint64_t *_llCycleCount;
		static uint64_t *_llScanlineStart, *_llNextScanlineStart, *_llHBlankStart;
		static uint32_t *_lScanline, *_lNextScanline, *_lVBlank_Y, *_lRasterYMax;
...
void CalibrateTimer_t ()
{
	...
	public:
		...
		*/
		...
		static constexpr char* REG_NAMES[][4] = {
			{"TIMER0_COUNT", "TIMER0_MODE", "TIMER0_COMP", "TIMER0_HOLD"},
			{"TIMER1_COUNT", "TIMER1_MODE", "TIMER1_COMP", "TIMER1_HOLD"},
...
#endif	// end #ifndef __PS2_TIMER_H__
