...
//#pragma once
#ifndef __PS2_IPU_H__
#define __PS2_IPU_H__
...
namespace Playstation2
{
	...
	public:
		...
		static constexpr char* REG_NAMES[4] = {
			"IPU_CMD", "IPU_CTRL", "IPU_BP", "IPU_TOP"
		};

		static constexpr char* REG_NAMES_FIFO[2] = {
			"IPU_OUT_FIFO", "IPU_IN_FIFO"
		};
...
#endif	// end #ifndef __PS2_IPU_H__
