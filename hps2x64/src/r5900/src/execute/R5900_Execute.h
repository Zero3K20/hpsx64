...
//#pragma once
#ifndef __R5900_EXECUTE_H__
#define __R5900_EXECUTE_H__
...
namespace R5900
{
	...
	namespace Instruction
	{
		...
		public:
			...
			static void EXECUTE_PS2_DOUBLE_MUL_SCALAR_AVX2(Instruction::Format i);

			template<const int ACCUM, const int bSub>
			static void EXECUTE_PS2_DOUBLE_ADD_SCALAR_AVX2(Instruction::Format i);

			template<const int ACCUM, const int bSub>
			static void EXECUTE_PS2_DOUBLE_MADD_SCALAR_AVX2(Instruction::Format i);
...
#endif	// end #ifndef __R5900_EXECUTE_H__
