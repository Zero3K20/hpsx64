...
//#pragma once
#ifndef __R5900_LOOKUP_H__
#define __R5900_LOOKUP_H__
...
//#define ENABLE_R5900_LOOKUP_TABLE
...
#else
			static u16 FindByInstruction(u32 instruction);
...
#endif	// end #ifndef __R5900_LOOKUP_H__
